<!-- This is homepage for admin when they hv logged in. -->
<?php
session_start();
...
<body>
                ...
                <div class="" id="top-nav">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item me-auto">
                            <!-- logout button -->
                            <a href="/Ebus_asm2/html/account/logout.php/" class="logout-btn">LOGOUT</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- 'main-content' class contains the main content between the top navigation bar and footer -->
    <div class="main-content">
        ...
        <!-- section to add food -->
        <div class="container">
            <p class="main-menu" style="text-align: center; ">Add food</p>

            <div class="add-food-form">
                <form action="/Ebus_asm2/html/menu/addFood.php/" method="post">
                    <div class="form-group row mb-2">
                        <label for="inputFoodName" class="col-sm-2 col-form-label">Name</label>
                        <input type="text" class="form-control" id="inputFoodName" name="foodname" placeholder="Food Name" required>
                    </div>

                    <div class="form-group row mb-2">
                        <label for="inputFoodPrice" class="col-sm-2 col-form-label">Price</label>
                        <input type="number" class="form-control" id="inputFoodPrice" name="foodprice" placeholder="Food Price" required>
                    </div>

                    <label for="inputFoodCata">Category</label>
                    <select class="form-control" id="inputFoodCata" name="foodcata" placeholder="Food Category" required>
                    ...
                    <div class="form-group row mb-2">
                        <label for="inputFoodDesc" class="col-sm-2 col-form-label">Description</label>
                        <textarea class="form-control" id="inputFoodDesc" name="fooddesc" placeholder="Food Description" required rows="4"></textarea>
                    </div>

                    <div class="form-group row mb-2">
                        <label for="inputFoodIngred" class="col-sm-2 col-form-label">Ingredients</label>
                        <textarea class="form-control" id="inputFoodIngred" name="foodingred" placeholder="Food Ingredients (seperate by comma)" required rows="4"></textarea>
                    </div>
